...
public class StandardTaskManagerCorsConfiguration extends UrlBasedCorsConfigurationSource {
    ...
    public StandardTaskManagerCorsConfiguration(String allowedUrls) {
