...
import com.sp.standardtaskmanager.web.filter.TraceFilter;
...
import static com.sp.standardtaskmanager.config.StandardTaskManagerCorsConfiguration.ALLOWED_HEADERS;
import static com.sp.standardtaskmanager.config.StandardTaskManagerCorsConfiguration.CORS_MAX_AGE_IN_SEC;
...
@Slf4j
public class StandardTaskManagerCorsProcessor extends DefaultCorsProcessor {

    private final List<String> allowedOrigins;

    public StandardTaskManagerCorsProcessor(String allowedUrls) {
