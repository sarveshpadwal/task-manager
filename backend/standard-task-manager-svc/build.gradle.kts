...
group = "com.sp.standardtaskmanager"
version = "0.0.1"
...
val nimbusJoseJwtVersion: String by extra("9.37.3")
...
application {
	mainClass.set("com.sp.standardtaskmanager.StandardTaskManagerSvcApplication")
}
...
tasks.jacocoTestCoverageVerification {
	violationRules {
		...
		rule {
			isEnabled = false
			element = "CLASS"
			includes = listOf("com.sp.standardtaskmanager.*")
